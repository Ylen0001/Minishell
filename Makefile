...
SRCS = $(addprefix $(SRC_DIR)/, minishell.c / builtin_env_ex.c / builtin_unset.c / builtin_ry.c / path_exec.c / lil_gnl.c / here_doc_handler.c / signal.c / prompt.c / init.c / parsing.c / workinprog_vect.c / garbage_collector.c)
